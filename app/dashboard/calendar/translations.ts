...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  pt: {
    ...
    agenda: 'Agenda',
    repeat: 'Repetir',
    repeatNone: 'Não repete',
    repeatDaily: 'Diário',
    repeatWeekly: 'Semanal',
    repeatFortnightly: 'Quinzenal',
    repeatMonthly: 'Mensal',
    editThis: 'Editar apenas este',
    editAll: 'Editar todos',
    deleteThis: 'Excluir apenas este',
  ...
  en: {
    ...
    editThis: 'Edit only this',
    editAll: 'Edit all',
    deleteThis: 'Delete only this',
  ...
  es: {
    ...
    agenda: 'Agenda',
    repeat: 'Repetir',
    repeatNone: 'No repite',
    repeatDaily: 'Diario',
    repeatWeekly: 'Semanal',
    repeatFortnightly: 'Quincenal',
    repeatMonthly: 'Mensual',
    editThis: 'Editar solo este',
    editAll: 'Editar todos',
    deleteThis: 'Eliminar solo este',
