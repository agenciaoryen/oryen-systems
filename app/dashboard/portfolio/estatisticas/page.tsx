...
const TRANSLATIONS = {
  pt: {
    ...
    leads: 'Leads',
    // Table
    tableTitle: 'Performance por Imóvel',
    property: 'Imóvel',
    visitors: 'Visitantes',
    gallery: 'Galeria',
    contacts: 'Contatos',
  ...
  es: {
    title: 'Estadísticas de Inmuebles',
    subtitle: 'Acompañe el rendimiento de cada inmueble en su sitio',
    refresh: 'Actualizar',
    loading: 'Cargando estadísticas...',
    noData: 'Sin datos disponibles para el período seleccionado',
    noProperties: 'Ningún inmueble registrado aún',
    totalViews: 'Visualizaciones',
    totalLeads: 'Leads Captados',
    avgConversion: 'Conversión Media',
    topProperty: 'Más Visto',
    activeProperties: 'Inmuebles Activos',
    chartTitle: 'Visualizaciones por Día',
    views: 'Visualizaciones',
    clicks: 'Clics',
    leads: 'Leads',
    tableTitle: 'Rendimiento por Inmueble',
    property: 'Inmueble',
    visitors: 'Visitantes',
    gallery: 'Galería',
    contacts: 'Contactos',
