...
interface PipelineHeaderProps {
  /** Ex: "03" — índice editorial à esquerda do kicker */
  index: string
  /** Ex: "DOSSIÊ" — primeira palavra do kicker */
  kicker: string
  /** Ex: "CRM" — última palavra do kicker, depois do separador */
  section: string
