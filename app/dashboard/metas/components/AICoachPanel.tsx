...
const TRANSLATIONS = {
  pt: {
    ...
    rateLimit: 'Limite diário atingido (10/dia). Tente amanhã.',
    noData: 'Clique em "Gerar Análise" para receber coaching estratégico baseado no seu progresso.',
    recommendations: 'Recomendações',
    paceAnalysis: 'Análise de Ritmo',
    priorityGoal: 'Meta Prioritária',
  },
  en: {
  ...
  es: {
    ...
    rateLimit: 'Límite diario alcanzado (10/día). Intente mañana.',
    noData: 'Haga clic en "Generar Análisis" para recibir coaching estratégico basado en su progreso.',
    recommendations: 'Recomendaciones',
    paceAnalysis: 'Análisis de Ritmo',
