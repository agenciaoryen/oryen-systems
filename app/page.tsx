  ...
  pt: {
    ...
    features: {
      ...
      items: [
        ...
        { title: 'Agentes de IA', description: 'IA que classifica, organiza e prioriza seus leads automaticamente. Saiba exatamente quem contatar primeiro, sem planilhas.' },
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: 'Feche mais negócios', description: 'Deixe a IA classificar e priorizar seus leads enquanto você foca no que importa: fechar.' },
      ],
    },
    highlightAi: {
      badge: 'Inteligência Artificial',
      title: 'Leads organizados, prioridades claras',
      subtitle: 'A IA da Oryen classifica automaticamente cada lead por etapa, interesse e potencial. Pipeline organizado, equipe alinhada — você sempre sabe qual é o próximo passo.',
      items: [
        'Classificação automática por etapa e interesse',
        'Priorização inteligente: saiba quem contatar primeiro',
        'Pipeline visual com status em tempo real',
        'Dashboards de conversão e performance',
      ],
      cards: [
        { label: 'Leads Classificados', value: '847', trend: '+23%' },
        { label: 'Pipeline Ativo', value: '12.4k', trend: '+18%' },
        { label: 'Prioridades Hoje', value: '156', trend: '+31%' },
        { label: 'Taxa de Conversão', value: '34%', trend: '+5%' },
      ],
    },
    highlightWa: {
      badge: 'Pipeline Inteligente',
      title: 'Cada lead no lugar certo, na hora certa',
      subtitle: 'Pipeline visual com todas as etapas do mercado imobiliário. Leads do WhatsApp, site e formulários caem direto no CRM, classificados e priorizados.',
      items: [
        'Leads do WhatsApp, site e formulários em um só lugar',
        'Classificação automática por etapa e interesse',
    ...
    whyOryen: {
      ...
      subtitle: 'Não somos apenas mais um CRM. Construímos uma plataforma que organiza, prioriza e fecha negócios.',
      items: [
        { title: 'IA que organiza de verdade', description: 'IA que classifica, organiza e prioriza seus leads automaticamente. Você sempre sabe quem contatar primeiro e qual o próximo passo.' },
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Os agentes de IA substituem minha equipe?', a: 'Não. A IA classifica, organiza e prioriza seus leads, liberando sua equipe para focar no atendimento personalizado e fechamento.' },
    ...
    finalCta: {
      ...
      subtitle: 'Junte-se aos corretores e imobiliárias que já usam IA para organizar seus leads e vender mais.',
      cta: 'Começar agora',
    },
    footer: {
  ...
  en: {
    ...
    features: {
      ...
      items: [
        ...
        { title: 'AI Agents', description: 'AI that classifies, organizes, and prioritizes your leads automatically. Always know who to contact first — no spreadsheets needed.' },
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: 'Close more deals', description: 'Let AI classify and prioritize your leads while you focus on what matters: closing.' },
      ],
    },
    highlightAi: {
      badge: 'Artificial Intelligence',
      title: 'Organized leads, clear priorities',
      subtitle: 'Oryen AI automatically classifies each lead by stage, interest, and potential. Organized pipeline, aligned team — you always know the next step.',
      items: [
        'Automatic classification by stage and interest',
        'Smart prioritization: know who to contact first',
        'Visual pipeline with real-time status',
        'Conversion and performance dashboards',
      ],
      cards: [
        { label: 'Classified Leads', value: '847', trend: '+23%' },
        { label: 'Active Pipeline', value: '12.4k', trend: '+18%' },
        { label: 'Priorities Today', value: '156', trend: '+31%' },
        { label: 'Conversion Rate', value: '34%', trend: '+5%' },
      ],
    },
    highlightWa: {
      badge: 'Smart Pipeline',
      title: 'Every lead in the right place, at the right time',
      subtitle: 'Visual pipeline with all real estate stages. Leads from WhatsApp, website, and forms land directly in the CRM — classified and prioritized.',
      items: [
        'Leads from WhatsApp, website, and forms in one place',
        'Automatic classification by stage and interest',
    ...
    whyOryen: {
      ...
      subtitle: 'We\'re not just another CRM. We built a platform that organizes, prioritizes, and closes deals.',
      items: [
        { title: 'AI that actually organizes', description: 'AI that classifies, organizes, and prioritizes your leads automatically. Always know who to contact first and what the next step is.' },
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Do AI agents replace my team?', a: 'No. AI classifies, organizes, and prioritizes your leads, freeing your team to focus on personalized service and closing.' },
    ...
    finalCta: {
      ...
      subtitle: 'Join the agents and brokerages already using AI to organize their leads and sell more.',
      cta: 'Get started',
    },
    footer: {
  ...
  es: {
    ...
    features: {
      ...
      items: [
        ...
        { title: 'Agentes de IA', description: 'IA que clasifica, organiza y prioriza sus leads automáticamente. Sepa siempre a quién contactar primero, sin planillas.' },
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { title: 'Cierra más negocios', description: 'Deja que la IA clasifique y priorice tus leads mientras tú te enfocas en lo que importa: cerrar.' },
      ],
    },
    highlightAi: {
      badge: 'Inteligencia Artificial',
      title: 'Leads organizados, prioridades claras',
      subtitle: 'La IA de Oryen clasifica automáticamente cada lead por etapa, interés y potencial. Pipeline organizado, equipo alineado — usted siempre sabe cuál es el próximo paso.',
      items: [
        'Clasificación automática por etapa e interés',
        'Priorización inteligente: sepa a quién contactar primero',
        'Pipeline visual con estado en tiempo real',
        'Dashboards de conversión y rendimiento',
      ],
      cards: [
        { label: 'Leads Clasificados', value: '847', trend: '+23%' },
        { label: 'Pipeline Activo', value: '12.4k', trend: '+18%' },
        { label: 'Prioridades Hoy', value: '156', trend: '+31%' },
        { label: 'Tasa de Conversión', value: '34%', trend: '+5%' },
      ],
    },
    highlightWa: {
      badge: 'Pipeline Inteligente',
      title: 'Cada lead en el lugar correcto, en el momento correcto',
      subtitle: 'Pipeline visual con todas las etapas del mercado inmobiliario. Leads del WhatsApp, sitio y formularios caen directo al CRM, clasificados y priorizados.',
      items: [
        'Leads del WhatsApp, sitio y formularios en un solo lugar',
        'Clasificación automática por etapa e interés',
        'Historial completo de conversaciones en el CRM',
    ...
    whyOryen: {
      ...
      subtitle: 'No somos solo otro CRM. Construimos una plataforma que organiza, prioriza y cierra negocios.',
      items: [
        { title: 'IA que organiza de verdad', description: 'IA que clasifica, organiza y prioriza sus leads automáticamente. Siempre sepa a quién contactar primero y cuál es el próximo paso.' },
    ...
    faq: {
      ...
      items: [
        ...
        { q: '¿Los agentes de IA reemplazan a mi equipo?', a: 'No. La IA clasifica, organiza y prioriza sus leads, liberando a su equipo para enfocarse en la atención personalizada y el cierre.' },
    ...
    finalCta: {
      ...
      subtitle: 'Únete a los corredores e inmobiliarias que ya usan IA para organizar sus leads y vender más.',
      cta: 'Empezar ahora',
    },
    footer: {
