...
<head>
  ...
  <style>
    ...
    .fallback { font-size: 13px; color: #6B7685; text-align: center; margin-top: 20px; }
    .fallback a { color: #5A7AE6; text-decoration: underline; }
...
<body>
  <div class="wrapper">
    ...
    <div class="content">
      ...
      <p class="fallback">${opts.fallbackLabel} <a href="${opts.ctaUrl}">${opts.ctaLabel}</a>.</p>
...
const CONFIRMATION_TRANSLATIONS: Record<EmailLang, {
  ...
  pt: {
    ...
    fallback: 'Se o botão acima não funcionar,',
  ...
  en: {
    ...
    cta: 'Confirm email',
    fallback: 'If the button above doesn\'t work,',
  ...
  es: {
    ...
    fallback: 'Si el botón de arriba no funciona,',
